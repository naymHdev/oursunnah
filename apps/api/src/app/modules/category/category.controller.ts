...
const getCategoryTree = catchAsync(async (_req: Request, res: Response) => {
  ...
  sendResponse(res, { statusCode: 200, success: true, message: "Category tree retrieved successfully", data: tree });
});
...
const getFeaturedCategories = catchAsync(async (_req: Request, res: Response) => {
  ...
  sendResponse(res, { statusCode: 200, success: true, message: "Featured categories retrieved successfully", data: categories });
});
...
const reorderCategories = catchAsync(async (req: Request, res: Response) => {
  ...
  sendResponse(res, { statusCode: 200, success: true, message: "Categories reordered successfully", data: null });
});
